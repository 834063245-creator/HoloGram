...
/// Simple thread/resource conflict detection using node-name pattern matching.
/// v1: scans node names for threading keywords and builds conflict matrix.
/// NOTE: does NOT scan file content — detection is name-based (thread/worker/async_task).
