...
/// `discovered_files` replaces a full-directory walkdir — the pipeline already
/// discovered every source file in Step 1.
...
pub fn synthesize_dynamic_edges(
    ...
    // Filter pipeline-discovered files to JS/TS/Python only
