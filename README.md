...
| 能力 | 说明 |
|---|---|
| **27 个 MCP 工具** | explore / neighbors / impact / path / coupling-report / blindspots / cycle / fragile / community / history / search / check / preflight / health / diff / timeline / policy-check / rename / node / unused 等。全部走图数据库查询，不读源文件。 |
...
<tr><td><code>unused</code></td><td>潜在死代码检测：in_degree=0 的符号，按 out_degree 降序排列</td></tr>
