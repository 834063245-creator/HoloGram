  ...
  static async open(
    ...
    try {
      ...
      try {
        ...
        ws.fileGraphData = JSON.parse(ChatPanel.stripLineNumbers(raw));
          ...
          if (nc > 0 && ws.path) {
            try {
              ...
              try {
                ...
                ws.fileGraphData = JSON.parse(ChatPanel.stripLineNumbers(await invoke<string>('read_file_content', { filePath: filesPath })));
