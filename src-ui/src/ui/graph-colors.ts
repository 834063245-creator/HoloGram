...
export const NODE_COLORS: Record<string, number> = {
  symbol: 0x6ab0ff, SYMBOL: 0x6ab0ff,
  function: 0x4ad8c8, FUNCTION: 0x4ad8c8,
  method: 0x4ad8c8, METHOD: 0x4ad8c8,
  class: 0x7fd84a, CLASS: 0x7fd84a,
  module: 0xd8d84a, MODULE: 0xd8d84a,
  interface: 0xf0a850, INTERFACE: 0xf0a850,
  variable: 0xf07070, VARIABLE: 0xf07070,
  constant: 0xd850b0, CONSTANT: 0xd850b0,
  medium: 0xf0c060, MEDIUM: 0xf0c060,
  file: 0xf0c060, FILE: 0xf0c060,
  database: 0xe0a040, DATABASE: 0xe0a040,
  cache: 0xd09030, CACHE: 0xd09030,
  queue: 0xc08020, QUEUE: 0xc08020,
  temporal: 0xc098ff, TEMPORAL: 0xc098ff,
  thread: 0xc098ff, THREAD: 0xc098ff,
  timer: 0xa880ff, TIMER: 0xa880ff,
  trigger: 0x9068ff, TRIGGER: 0x9068ff,
};
...
const _EDGE_COLORS: Record<string, number> = {
  calls: 0x4a9adf, imports: 0x4adfdf, defines: 0x4adf8a, inherits: 0xff66dd,
  reads: 0x66dd66, writes: 0xff5566, shares: 0xffaa44,
  triggers: 0xff8833, awaits: 0xc068ff, sequences: 0x8866ff,
  data: 0xff5566, temporal: 0xff8833, structural: 0x4a9adf,
};
...
export function hexToCSS(hex: number): string { return '#' + hex.toString(16).padStart(6, '0'); }
