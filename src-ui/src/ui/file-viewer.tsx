...
export class FileViewer {
  ...
  private mdPreviewRoot: Root | null = null;
  ...
  private renderMarkdownPreview(content: string): void {
    if (!this.mdPreviewRoot) {
      this.mdPreviewRoot = createRoot(this.previewContainer);
    }
    this.mdPreviewRoot.render(<MarkdownFilePreview content={content} />);
  }

  private unmountMarkdownPreview(): void {
    if (this.mdPreviewRoot) {
      this.mdPreviewRoot.unmount();
      this.mdPreviewRoot = null;
    }
  }

  private async renderImagePreview(filePath: string): Promise<void> {
    this.unmountMarkdownPreview();
